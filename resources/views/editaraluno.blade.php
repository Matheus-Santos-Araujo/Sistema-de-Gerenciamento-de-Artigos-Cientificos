		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="/editaraluno">
						{!! csrf_field() !!}
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" name="matricula" value="{{$p->matricula}}">
							</div>
                        </div>
                        <input id="id" name="id" type="hidden" value="{{$p->id}}">
                        @endforeach
						<input id="tipo" name="tipo" type="hidden" value="aluno">
